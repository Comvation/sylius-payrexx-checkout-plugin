...
namespace Tests\Comvation\SyliusPayrexxCheckoutPlugin\Behat\Context\Ui\Shop;

use Behat\Behat\Context\Context;
use Tests\Comvation\SyliusPayrexxCheckoutPlugin\Behat\Page\Shop\WelcomePageInterface;
